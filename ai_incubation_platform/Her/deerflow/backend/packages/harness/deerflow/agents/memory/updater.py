...
def import_memory_data(memory_data: dict[str, Any], agent_name: str | None = None, user_id: str | None = None) -> dict[str, Any]:
    ...
    Args:
        ...
        user_id: If provided, imports into per-user memory.
    ...
    if not storage.save(memory_data, agent_name, user_id):
        raise OSError("Failed to save imported memory data")
    return storage.load(agent_name, user_id)


def clear_memory_data(agent_name: str | None = None, user_id: str | None = None) -> dict[str, Any]:
    """Clear all stored memory data and persist an empty structure."""
    cleared_memory = create_empty_memory()
    if not _save_memory_to_file(cleared_memory, agent_name, user_id):
...
class MemoryUpdater:
    ...
    def update_memory(
        ...
        Args:
            ...
            user_id: If provided, updates per-user memory. Each user has independent memory file.
