...
# P20 模型注册到统一模型中心
# ============================================
# 注意：EmotionAnalysisDB 已在 p11_models 中定义，此处不重复定义
# P20 的情感分析专注于聊天会话分析，与 P11 的视频面诊不同
# 如需使用情感趋势模型，请使用 ChatEmotionTrendDB（P20 专用）


class ChatEmotionTrendDB(Base):
    """聊天情感趋势记录 (P20 专用 - 专注于聊天会话分析)

    与 P11 的 EmotionalTrendDB 区别:
    - P11: 基于视频面诊/语音的情感趋势
    - P20: 基于聊天文本的情感趋势
    """
