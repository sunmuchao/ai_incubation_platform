"""
AutonomousDating-SocialTribe-StressTest API 层

AutonomousDating 虚实结合 - 全自动关系管家
SocialTribe 圈子融合 - 生活圈的介绍人
StressTest 终极共振 - 人生合伙人
"""
...
from services.stress_test_service import stress_test_service, growth_plan_service, trust_service


# ==================== AutonomousDating 虚实结合 API ====================

router_date_plan = APIRouter(prefix="/api/autonomous-dating", tags=["自主约会策划"])
router_album = APIRouter(prefix="/api/relationship-albums", tags=["情感纪念册"])
...
# ==================== SocialTribe 圈子融合 API ====================

router_tribe = APIRouter(prefix="/api/social-tribes", tags=["部落匹配"])
router_digital_home = APIRouter(prefix="/api/digital-homes", tags=["数字小家"])
router_family_sim = APIRouter(prefix="/api/family-meeting-simulation", tags=["见家长模拟"])
...
router_stress_test = APIRouter(prefix="/api/relationship-stress-tests", tags=["关系压力测试"])
router_growth = APIRouter(prefix="/api/growth-plans", tags=["成长计划"])
router_trust = APIRouter(prefix="/api/trust-endorsements", tags=["信任背书"])
