...
export const milestoneApi = {
  ...
  async recordMilestone(request: RecordMilestoneRequest): Promise<{ milestone_id: string; status: string }> {
    const response = await apiClient.post('/api/milestones/record', request)
  ...
  async getMilestoneTimeline(
    ...
    const response = await apiClient.get(`/api/milestones/timeline/${user_id_1}/${user_id_2}`, {
  ...
  async getMilestoneDetails(milestone_id: string): Promise<Milestone> {
    const response = await apiClient.get(`/api/milestones/${milestone_id}`)
    return response.data
  },
  ...
  async updateMilestone(
    ...
    const response = await apiClient.put(`/api/milestones/${milestone_id}`, request)
    return response.data
  },
  ...
  async celebrateMilestone(
    ...
    const response = await apiClient.post(`/api/milestones/${milestone_id}/celebrate`, null, {
  ...
  async getMilestoneStatistics(
    ...
    const response = await apiClient.get(`/api/milestones/stats/${user_id_1}/${user_id_2}`)
    return response.data
  },
  ...
  async generateInsight(request: {
    ...
    const response = await apiClient.post('/api/milestones/insights/generate', request)
    return response.data
  },
  ...
  async getUserInsights(
    ...
    const response = await apiClient.get(`/api/milestones/insights/${user_id}`, {
  ...
  async markInsightRead(
    ...
    const response = await apiClient.post(`/api/milestones/insights/${insight_id}/read`, {
      user_id,
    })
    return response.data
  },
...
export const dateSuggestionApi = {
  ...
  async generateDateSuggestion(
    ...
    const response = await apiClient.post('/api/date-suggestions/generate', {
      user_id,
      target_user_id,
      date_type,
      preferences,
  ...
  async getUserDateSuggestions(
    ...
    const response = await apiClient.get(`/api/date-suggestions/list/${user_id}`, {
      params: { status, limit },
    })
    return response.data
  },
  ...
  async respondToDateSuggestion(
    ...
    const response = await apiClient.post(`/api/date-suggestions/${suggestion_id}/respond`, request)
    return response.data
  },
  ...
  async getDateVenues(
    ...
    const response = await apiClient.get('/api/date-suggestions/venues', {
  ...
  async addDateVenue(venue: Omit<DateVenue, 'id'>): Promise<{ venue_id: string; status: string }> {
    const response = await apiClient.post('/api/date-suggestions/venues', venue)
    return response.data
  },
}
...
export const coupleGameApi = {
  ...
  async createCoupleGame(
    ...
    const response = await apiClient.post('/api/couple-games/create', {
      user_id_1,
      user_id_2,
      game_type,
      game_config,
  ...
  async getUserGames(
    ...
    const response = await apiClient.get(`/api/couple-games/list/${user_id}`, {
      params: { status, limit },
    })
    return response.data
  },
  ...
  async getGameDetails(game_id: string): Promise<{ game: CoupleGame }> {
    const response = await apiClient.get(`/api/couple-games/${game_id}`)
    return response.data
  },
  ...
  async startGame(
    ...
    const response = await apiClient.post(`/api/couple-games/${game_id}/start`, { user_id })
    return response.data
  },
  ...
  async submitGameRound(request: SubmitGameRoundRequest): Promise<{ status: string; round_result: any }> {
    const response = await apiClient.post(`/api/couple-games/${request.game_id}/round`, request)
    return response.data
  },
  ...
  async completeGame(
    ...
    const response = await apiClient.post(`/api/couple-games/${game_id}/complete`, { user_id })
    return response.data
  },
  ...
  async getGameInsights(game_id: string): Promise<{ insights: GameInsights }> {
    const response = await apiClient.get(`/api/couple-games/${game_id}/insights`)
    return response.data
  },
}
