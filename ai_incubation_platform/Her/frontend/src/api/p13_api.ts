...
export const loveLanguageProfileApi = {
  ...
  async analyzeUserLoveLanguage(
    ...
    const response = await apiClient.post('/apiClient/p13/love-language-profile/analyze', { user_id })
  ...
  async getUserLoveLanguageProfile(
    ...
    const response = await apiClient.get(`/apiClient/p13/love-language-profile/${user_id}`)
    return response.data
  },
  ...
  async getLoveLanguageDescription(
    ...
    const response = await apiClient.get(`/apiClient/p13/love-language-profile/description/${love_language}`)
    return response.data
  },
}
...
export const relationshipTrendApi = {
  ...
  async generateTrendPrediction(
    ...
    const response = await apiClient.post('/apiClient/p13/relationship-trend/predict', {
      user_a_id,
      user_b_id,
      prediction_period,
    })
  ...
  async getTrendPrediction(
    ...
    const response = await apiClient.get(`/apiClient/p13/relationship-trend/${prediction_id}`)
    return response.data
  },
}
...
export const warningResponseApi = {
  ...
  async getWarningResponseStrategy(
    ...
    const response = await apiClient.post('/apiClient/p13/warning-response/strategy', {
      warning_level,
      context,
    })
    return response.data
  ...
  async executeWarningResponse(
    ...
    const response = await apiClient.post('/apiClient/p13/warning-response/execute', request)
    return response.data
  },
  ...
  async submitWarningResponseFeedback(
    ...
    const response = await apiClient.post('/apiClient/p13/warning-response/feedback', request)
    return response.data
  },
  ...
  async getUserWarningResponseHistory(
    ...
    const response = await apiClient.get(`/apiClient/p13/warning-response/history/${user_id}`)
    return response.data
  },
  ...
  async getUserWarnings(
    ...
    const response = await apiClient.get(`/apiClient/p12/emotion/warnings/${user_id}`, {
...
export const comprehensiveAnalysisApi = {
  ...
  async comprehensiveRelationshipAnalysis(
    ...
    const response = await apiClient.post('/apiClient/p13/comprehensive/analyze', {
      user_a_id,
      user_b_id,
    })
    return response.data
