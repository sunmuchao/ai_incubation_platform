...
router_notifications = APIRouter(prefix="/api/notifications", tags=["P9-通知系统"])
router_share = APIRouter(prefix="/api/share", tags=["P9-分享机制"])
...
async def get_share_posters(
    ...
    """获取分享海报模板列表"""
    from models.p9_models import SharePosterDB
