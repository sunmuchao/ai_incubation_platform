...
访问 API 文档：http://localhost:8007/docs
...
# 运行特定阶段测试
pytest tests/test_p0_optimizations.py -v
pytest tests/test_p4_features.py -v
pytest tests/test_p6_features.py -v
pytest tests/test_p7_features.py -v
...
根据 [VISION.md](./VISION.md)，我们的核心 AI 能力：
...
详细 API 文档请查看：http://localhost:8007/docs
...
├── tests/                      # 测试文件
│   ├── test_api.py
│   ├── test_p0_optimizations.py
│   ├── test_p4_features.py
│   ├── test_p6_features.py
│   ├── test_p7_features.py     # P7 功能测试
│   ├── test_p8_features.py     # P8 功能测试
│   ├── test_p9_features.py     # P9 功能测试
│   └── ...
├── frontend/                   # 前端页面
│   ├── index.html
│   └── swipe.html
...
详见 [PROJECT_DOCUMENTATION.md](./PROJECT_DOCUMENTATION.md)
...
- 项目地址：https://github.com/your-org/matchmaker-agent
