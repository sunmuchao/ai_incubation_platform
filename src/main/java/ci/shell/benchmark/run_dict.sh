...
sed -i "$str2" /usr/banchMark/home/.polars_meta/polars.properties
java -Xmx24G -Xms24G -Dpolars.native.supported=false  -cp .:./polars-benchmark.jar com.fanruan.polars.benchmark.cases.BenchmarkCaseRunner /usr/banchMark/benchmark_Customization.properties